 ...
 * In addition, I assume the neural network contains only one hidden layer!  No other structure is supported.
 */
public class MakeDLModelV3 extends SchemaV3<Iced,MakeDLModelV3> {
